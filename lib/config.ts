...
/** Canonical production URL. Domain reserved on GoDaddy (point DNS at Vercel). */
...
export const DISCLAIMER =
  "Sea Isle Eats is an open-source community guide, not an ordering platform. We link to restaurants' own menus and ordering; we don't take orders or payments.";
